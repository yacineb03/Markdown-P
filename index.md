...
### Mon Focus actuel
*   **Frontend** : apprentissage de la création d’interfaces web avec JavaScript et React.
*   **Backend** : bases en développement backend, structuration de données et premières API en PHP et MySQL.
*   **Soft skills** : travail en équipe, adaptabilité et curiosité pour les technologies web.
